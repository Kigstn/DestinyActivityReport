...
<template>
  <div class="flex w-full h-full justify-around">
    ...
    <div class="flex flex-col h-full grow max-w-[1600px]">
    <TabsRoot class="flex flex-col w-full h-full" default-value="Pinned">
      <TabsList class="flex gap-4" aria-label="Show pinned or all activities">
        ...
        <TopicBarNEW name="All Activities">
      ...
      <TabsContent class="flex flex-col h-full"        value="Pinned"      >
        <!-- Activities -->
          <div
                ...
                class="w-full grow-0 overflow-y-auto h-[calc(100% - 20rem)]"
            >
      ...
      <TabsContent        class="grow p-5 h-full"        value="All Activities"      >
        <div>
          <div>
                      <!-- todo -->
